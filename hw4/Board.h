...
public:
	...
	Board (std::string board_file_namey,std:: string dictfile);
   ...
   bool inlineValid(const std::vector<Tile*>& attplay, const size_t startx, const size_t starty, const bool horizontal);
